...
project_path = [p.parent for p in Path(__file__).resolve().parents if p.name == 'data'][0]
...
from data.o3 import MemmapDataset
...
if __name__ == "__main__":
    ...
    train_meshes, train_volumes = _generate_meshes(65536) # 65536 16384 4096 1024 256
    val_meshes, val_volumes = _generate_meshes(65536)
    test_meshes, test_volumes = _generate_meshes(65536)
